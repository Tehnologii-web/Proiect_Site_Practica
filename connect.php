<?
    ...
    if($conn->connect_error){
        ...
        $stmt = $conn->prepare("insert into jobs offers(company_name, offer_type, offer_title, offer_description, number_of_places, candidate_requirements, company_website)
                values(?,?,?,?,?,?,?)");
